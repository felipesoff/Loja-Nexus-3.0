    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 bg-[#0B0F17]">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-black text-white tracking-tighter uppercase">BEM-VINDO À NEXUS</h1>
          <p className="text-gray-400 font-medium mt-2">Entre na sua conta para continuar</p>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-end">
              <button
                ...
                className="text-[10px] font-bold text-gray-400 hover:text-[#CCFF00] uppercase tracking-widest transition-colors flex items-center gap-1"
              >
                <HelpCircle size={12} />
                Esqueci minha senha
              </button>
        ...
        <div className="mt-10 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-400 text-sm font-medium mb-4">Ainda não tem uma conta?</p>
          <Link
            to="/signup"
          ...
          >
            Criar conta Nexus <UserPlus size={16} />
          </Link>
        </div>
      </motion.div>
    </div>
